...
public:
    ...
    void set_chrom_order(const std::string order [], const int &size);
    ...
    void set_columns(const std::string columns [], const int &size);
    void set_chromosomes(const std::string chrom [], const int length [], const int &size);
    
    void add_column(const std::string &c);
    void add_chromosome(const std::string &c, const int length);
...
private:
    std::string version,sorted,shape,genome_assembly,command;
